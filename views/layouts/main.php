    ...
    <div class="navbar-collapse collapse padding-left-0">
        ...
        <ul id="main-menu" class="nav navbar-nav navbar-right">
            ...
            <?php } else { ?>
                <li>
                    <a tabindex="-1"
                       href="<?= Url::to(['/site/logout']) ?>"><?= Yii::$app->user->identity->username . ' ' . Yii::t('app', '退出')?></a>
                </li>
            <?php } ?>
            <li>
...
<div class="content">
    ...
    <footer>
        <hr>
        <p class="text-center"><a href="javascript:void(0)" target="_blank">&copy; My
                Company <?= date('Y') ?> <?= ExplorerCheck::SOFT_VERSION ?></a></p>
    </footer>
</div>
