...
class PHPExcel_Writer_Excel2007_Chart extends PHPExcel_Writer_Excel2007_WriterPart
{
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	private function _writeTitle(PHPExcel_Chart_Title $title = null, $objWriter = null)
	{
		if (is_null($title) || is_null($objWriter)) {
			return;
		}
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	private function _writeLegend(PHPExcel_Chart_Legend $legend = null, $objWriter = null)
	{
		if (is_null($legend) || is_null($objWriter)) {
			return;
		}
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	private function _writePlotArea(PHPExcel_Chart_PlotArea $plotArea = null,
...
//										$objWriter->writeAttribute('xml:space', 'preserve');
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	private function _writePlotSeriesValues( $plotSeriesValues = null,
											 $objWriter = null,
											 $groupType = null,
											 $dataType='str',
											 PHPExcel_Worksheet $pSheet = null
	...
	{
		if (is_null($plotSeriesValues) || is_null($objWriter) || is_null($groupType) || is_null($dataType)) {
			return;
		}
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	private function _writeLayout(PHPExcel_Chart_Layout $layout = NULL, $objWriter = null)
	{
