...
//			if ($row + 1 > 65536 or $column + 1 > 256) {
	...
	private function _writeCFRule(PHPExcel_Style_Conditional $conditional){
		...
		$flags |= (true              ? 0x00000010 : 0);
		$flags |= (1 == $bIndent       ? 0x00000020 : 0);
		$flags |= (1 == $bShrinkToFit  ? 0x00000040 : 0);
		// Default
		$flags |= (true              ? 0x00000080 : 0);
		// Protection
		...
		$flags |= (true              ? 0x00004000 : 0); // Top left to Bottom right border
		$flags |= (true              ? 0x00008000 : 0); // Bottom left to Top right border
		// Pattern
		$flags |= (1 == $bFillStyle    ? 0x00010000 : 0);
		$flags |= (1 == $bFillColor    ? 0x00020000 : 0);
		$flags |= (1 == $bFillColorBg  ? 0x00040000 : 0);
		$flags |= (true              ? 0x00380000 : 0);
		// Font
		...
		if($bFormatFont == 1){
			...
			$optionsFlags |= (true                  ? 0x00000008 : 0);
			$optionsFlags |= (true                  ? 0x00000010 : 0);
			$optionsFlags |= (1 == 0                  ? 0x00000020 : 0);
			$optionsFlags |= (true                  ? 0x00000080 : 0);
